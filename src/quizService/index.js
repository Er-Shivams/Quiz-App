const qBank = [
  {
    ...
    answers: ["James Gosling", "Alan Sugar", "Charel Babbage", "Bill Gates"],
  ...
  },
  {
    ...
    answers: ["Transfer statements", "Loop Statements", "Selection statements", "Pause Statement"],
